...
public class StorageBuilding : Building
{
    ...
    {
        ResourcePair resourcePair = new ResourcePair(StoredResource, StorageIncrease);
        GameKernel.Instance.GetSystem<ResourceSystem>().DecreaseStorage(_data.Owner, resourcePair);
